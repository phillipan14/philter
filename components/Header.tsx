      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="mt-2.5 text-[var(--text-secondary)] text-sm">
            LinkedIn profile monitoring, powered by{" "}
            <a href="https://skylarq.ai" target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] hover:underline">Skylarq</a>
          </p>
        </div>
